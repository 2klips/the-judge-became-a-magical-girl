...
| `doyun.employee_id_surprised` | `char_doyun_employee_id_surprised.png` | 평상복·사원증 surprise | 1200×2000 PNG 투명 | 800KB | 필수 | ready | 사용자 생성·직접 제공, exact 모델/작업 ID 미확인; Pillow 기계 정규화·deterministic alpha cleanup | 신규 납품 reference 증빙 미확인·법률 자문 아님 | N5 사원증 부상 첫 beat 전용 | 원본 보존. 분리된 `!` component만 제거하고 비율 유지·투명 canvas 정규화. 2026-08-23에는 baseline `39f4370`의 반투명 magenta fringe 1,923px만 alpha 0으로 정리했으며 artifact RGB와 그 밖 pixel 변경은 0이다. source/runtime 동일 바이트·291,030B·SHA-256 `E92AD2F508207C20D8F17B1747E09537F5A1B0248AA05363A5EB645C76174E70`. HQ-03 `HUMAN_RECHECK` |
