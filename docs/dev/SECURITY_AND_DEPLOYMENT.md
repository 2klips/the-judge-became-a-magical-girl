...
- 로테이션 후 이전 키는 Google 콘솔에서 폐기하고 배포·smoke test를 다시 수행한다.
...
- 정적 번들은 Worker endpoint URL만 알며 Gemini 키를 알지 못한다.
...
- [ ] Gemini 모델 ID·쿼터 확인
- [ ] production/예비 키 Secret 등록, 코드 미포함
